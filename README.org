...
- Cross check the faststructure by running ADMIXTURE.
...
** TODO Recombination rate in sliding windows with LDhelmet. max 50 individuals per population.
** DONE Plot the unfolded SFS.
