...
** SFS plotting
plot the sfs with neutral model expectation and zoomed windows using the ggmagnify package (https://hughjonesd.github.io/ggmagnify/).
...
- how can I do this with popgenome?
