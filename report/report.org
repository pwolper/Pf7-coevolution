...
#+begin_src bash
plink2 --vcf ../vcf/chr11/Pf3D7_11_v3.afr_samples.qSNP.GT_filtered.renamed.vcf.gz --make-bed \
    --allow-extra-chr -out Pf3D7_11_v3.afr_samples.qSNP.GT_filtered.renamed
...
#+begin_src bash
nucmer --mum -p chr11/Pf7_PrCDC ../Pf7/seqs/Pf3D7_11_v3.fasta ../P.reichenowi/embl.PrCDC/PrCDC_11_v3.fasta
...
awk 'NR>3 && $2 !~ /\./ && $3 !~ /\./ {print}' chr11/Pf7_PrCDC_SNPs.txt > chr11/Pf7_PrCDC_11_SNPs_formatted.txt
#+end_src
