...
#+name: admix_Kmeans
#+caption: Admixture analyis of /P. falciparum/ samples, sorted by /de novo/ clusters, identified using K-means. (A) Chromosome 2 and (B) 11.
...
#+caption: Mapping coverage of /P. reichenowi/ PrCDC aligned to the  /P. falciparum/ Pf3D7 reference genome (/Pf7/), chromosome 2.
...
#+caption: Mapping coverage of /P. reichenowi/ PrCDC aligned to the  /P. falciparum/ Pf3D7 reference genome (/Pf7/), chromosome 11.
#+attr_latex: :width 0.6\textwidth :center t : float nil
#+attr_html: :width 400px :align center
...
*** DAPC
In order to run the dapc on our vcf files we used the R package /vcfR/ ([[cite:&knaus-2017-vcfr]]) to read in the file and convert it to a genlight object. Subsequently, we read in a vector of country membership and set haploidy. The dapc is conducted according to guideslines stated in [[cite:&thia-2022-guidel-stand]].
