...
bcftools view \
    ...
    --samples-file $samples_dir/Pf7_subset_samples.txt \
    --output-type z\
    --output-file  $vcf_dir/Pf3D7_02_v3.samples.SNP.vcf.gz \
    $vcf_dir/Pf3D7_02_v3.pf7.vcf.gz

echo FINISHED writing output file on $(date)

bcftools index -t $vcf_dir/Pf3D7_02_v3.samples.SNP.vcf.gz
